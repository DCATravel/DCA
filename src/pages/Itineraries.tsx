...
export default function Itineraries() {
  ...
  const filteredItineraries = useMemo(() => {
    return itineraries.filter((it) => {
      const matchesSearch =
        it.title.toLowerCase().includes(deferredSearchQuery.toLowerCase()) ||
        it.destination.toLowerCase().includes(deferredSearchQuery.toLowerCase());
  ...
  }, [deferredSearchQuery, selectedCategory, selectedSeason]);
