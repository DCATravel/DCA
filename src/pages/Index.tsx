    ...
    <div className="min-h-screen bg-background text-foreground flex flex-col font-sans">
      ...
      <section
        className="
          ...
          mt-2 sm:mt-4 rounded-[1.75rem] sm:rounded-3xl shadow-sm
          min-h-[560px]
          h-[clamp(560px,72vh,800px)]
          2xl:max-w-[1760px]
        "
      >
      ...
      <main className="flex-grow w-full">
        ...
        <section
          ...
          "
        >
          <div className="text-center mb-7 md:mb-9 max-w-3xl mx-auto">
            <span className="text-sm font-semibold text-secondary uppercase tracking-[0.22em]">
              Itinerarios destacados
            </span>

            <h2 className="mt-3 text-3xl md:text-4xl font-bold text-foreground mb-3">
              Programas listos para cotizar y compartir.
            </h2>

            <p className="text-muted-foreground text-base sm:text-lg leading-relaxed">
              Una selección de experiencias pensadas para inspirar a tus clientes y
              facilitar el trabajo comercial de tu agencia.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6 auto-rows-fr">
            {featuredItineraries.map((item) => (
              <Link
                ...
                "
              >
                <div className="relative h-30 sm:h-40 lg:h-44 overflow-hidden shrink-0 rounded-t-2xl isolate">
                  <img
                    src={item.image}
                    alt={item.title}
                    loading="lazy"
                ...
                <div className="p-2 flex flex-col flex-1">
                  <h3 className="font-bold text-foreground text-base mb-1 line-clamp-2 min-h-[2.5rem]">
                    {item.title}
                  </h3>

                  <div className="flex items-start gap-1.5 text-xs sm:text-sm text-muted-foreground mb-2 min-h-[2rem]">
          ...
          <div className="relative rounded-3xl overflow-hidden shadow-lg">
            ...
            <div className="relative z-10 px-6 sm:px-10 py-16 md:py-24 text-center">
              ...
              <p className="text-primary-foreground/85 text-base sm:text-lg leading-relaxed max-w-2xl mx-auto mb-10">
                ...
                para que tu agencia tenga una presencia más profesional en redes
                y canales digitales.
              </p>
